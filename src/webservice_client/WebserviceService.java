 ...
 * 
 */
@WebServiceClient(name = "WebserviceService", targetNamespace = "http://webservice/", wsdlLocation = "http://localhost:9001/Service/Webservice?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9001/Service/Webservice?wsdl");
